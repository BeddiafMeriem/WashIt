            ...
            <div id="content">
                        ...
                        ?>
                            <div  style="width:100%;margin-left:%;display:table; border:0px">
                                ...
                                <div  style="display:table-row; height:200px" align="center">
                                    <div  style="display:table-cell;width:50%">
                                    <a href="LastMonthHR.php">
                                        <div align="center" style="background-color: white;  border: #ADB5BD ; font-size: 15px; font-weight: bold;text-align:center;width:60%;height:200px; box-shadow: 5px 5px rgba(192,192,192,0.3)" > <input type="text" value="Les Heures travaillées:" style="margin-top:20%;border:0; text-align:center;font-size:20px;width:100%" readonly> <input type="text" value="100" style="border:0; text-align:center;font-size:40px;width:100%" readonly> <br> HEURES</div><br>           
                                    </a>
                                    </div>
                                    <div  style="display:table-cell;width:50%;">
                                    <a href="LastMonthKM.php">
                                        <div  style="background-color: white;  border: white ; font-size: 15px; font-weight: bold;text-align:center; width:60%;height:200px; box-shadow: 5px 5px rgba(192,192,192,0.3);"> <input type="text" value="La Distance Parcourue:" style="margin-top:20%;border:0; text-align:center;font-size:20px;width:100%" readonly> <input type="text" value="3564" style="border:0; text-align:center;font-size:40px;width:100%" readonly> <br> Km PARCOURUS </div><br>
                                    </a>
                                    </div>
                                </div>
                            </div>
