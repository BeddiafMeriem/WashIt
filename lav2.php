        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <div align="center" style="background:#F2F2F2;padding-bottom:20px;margin-top:20px; margin-right:2px; margin-left:2px">
                 ...
                 ?>
                    ...
                    <li class="active">
                    <a style="margin-top:20%" href="lav2.php">Accueil</a>
                    </li>
            ...
            <div id="content">
                        ...
                        <div class="navbar-header">
                            ...
                            <h2 align="center" style="">LAVERIE TAYBA </h2>
                        <?php 
                    ...
                    $query4="select COUNT(*) as existe from commandes,cites where (collecte=1 and lave=0) and (adresse = 'Baya Hocine' or adresse = 'Dergana' or adresse = 'Abdelkader Belarbi' or adresse = 'Bab Ezzouar 03') order by(cites.ordre)";
                    ...
                    if($existe != 0)
                    {
                        ...
                        $query1="select * from commandes where (collecte=1 and lave=0) and (adresse = 'Baya Hocine' or adresse = 'Dergana' or adresse = 'Abdelkader Belarbi' or adresse = 'Bab Ezzouar 03') order by(adresse)";
