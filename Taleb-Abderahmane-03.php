        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <div align="center" style="background:#F2F2F2;padding-bottom:20px;margin-top:20px; margin-right:2px; margin-left:2px">
                 ...
                 $name = $obj->name;
                 echo "<a style='outline: none;text-decoration: none;font-size:19px;font-weight:bold;color:black;background:#F2F2F2;width:90%;margin-left:; margin-bottom: 50px;padding-top:10px;' href='transport-profile.php'> $name </a>";
            ...
            <div id="content">
                        ...
                        <h2 align="center" id="nomCite" style=" padding-bottom:2%">Taleb Abderahmane 03</h2>
                ...
                if($date = date('N') == 3){ // == 4   COLLECTE
                    ...
                    $query4="select COUNT(*) as existe from commandes where (dateCol = curdate()) and adresse = 'Taleb Abderahmane 03' and (collecte = 0 and affiche = 0)";
                    ...
                    if($existe != 0)
                    {
                        ...
                        $query1="select * FROM commandes where (dateCol = curdate()) and adresse = 'Taleb Abderahmane 03' and (collecte = 0 and affiche = 0)";
                                ...
                                echo '<div  style="width:100%;margin-left:%;display:table; border:0px">';
                                    echo '<div  style="display:table-row;background:white; height:50px" align="center">';
                                        echo '<div  style="display:table-cell;width:20%;">';
                                            echo '<input  style="background-color: white;  border: white ; font-size: 15px; font-weight: bold;text-align:center; width:100%" type="number" name="NCmd" id="NCmd" value="'.$idCmd.'" readonly/> <br>'; 
                                        echo '</div>';
                ...
                if($date = date('N') == 6){ // == 6   LIVRAISON
                    ...
                    $query4="select COUNT(*) as existe from commandes where (dateLiv = curdate()) and adresse = 'Taleb Abderahmane 03' and (collecte = 1 and livre = 0)";
                    $result4=mysqli_query($link,$query4);
                    $obj4= mysqli_fetch_object($result4);
                    $existe = $obj4->existe;
                    if($existe != 0)
                    {
                        ...
                        $query5="select * FROM commandes where (dateLiv = curdate()) and adresse = 'Taleb Abderahmane 03' and (collecte = 1 and livre = 0)";
