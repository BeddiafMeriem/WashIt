    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                        ...
                        <h2 align="center" id="nomCite" style=" padding-bottom:2%">Taleb Abderahmane 01</h2>
                        <?php
                ...
                if($date = date('N') == 4){ // == 4   COLLECTE
                    ...
                    $query4="select COUNT(*) as existe from commandes where (dateCol = curdate()) and adresse = 'Taleb Abderahmane 01' and (collecte = 0 and affiche = 0)";
                    ...
                    if($existe != 0)
                    {
                        ...
                        $query1="select * FROM commandes where (dateCol = curdate()) and adresse = 'Taleb Abderahmane 01' and (collecte = 0 and affiche = 0)";
                ...
                if($date = date('N') == 6){ // == 6   LIVRAISON
                    ...
                    $query4="select COUNT(*) as existe from commandes where (dateLiv = curdate()) and adresse = 'Taleb Abderahmane 01' and (collecte = 1 and livre = 0)";
                    $result4=mysqli_query($link,$query4);
                    $obj4= mysqli_fetch_object($result4);
                    $existe = $obj4->existe;
                    if($existe != 0)
                    {
                        ...
                        $query5="select * FROM commandes where (dateLiv = curdate()) and adresse = 'Taleb Abderahmane 01' and (collecte = 1 and livre = 0)";
