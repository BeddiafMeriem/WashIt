    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                        ...
                        <h2 align="center" id="nomCite" style=" padding-bottom:2%"></h2>
...
window.onload = function () {
    ...
    if(data.name == "Bab%20Ezzouar%2005")
    {
        document.getElementById('nomCite').innerHTML = "Bab Ezzouar 05"; 
    }
    else 
    {
    document.getElementById('nomCite').innerHTML = data.name;
    }
    var nom = document.getElementById('nomCite').innerHTML;
    alert("hello");
    $.ajax({
