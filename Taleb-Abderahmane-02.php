    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                        ...
                        <h2 align="center" id="nomCite" style=" padding-bottom:2%">Taleb Abderahmane 02</h2>
                        <?php
                ...
                if($date = date('N') == 4){ // == 4   COLLECTE
                    ...
                    $query4="select COUNT(*) as existe from commandes where (dateCol = curdate()) and adresse = 'Taleb Abderahmane 02' and (collecte = 0 and affiche = 0)";
                    ...
                    if($existe != 0)
                    {
                        ...
                        $query1="select * FROM commandes where (dateCol = curdate()) and adresse = 'Taleb Abderahmane 02' and (collecte = 0 and affiche = 0)";
                                ...
                                echo '<div  style="width:100%;margin-left:%;display:table; border:0px">';
                                    echo '<div  style="display:table-row;background:white; height:50px" align="center">';
                                        ...
                                        echo '<div  style="display:table-cell;width:15%">';
                                            ...
                                            <input style="margin-top:7px;background-color:red; border:#41C821" type="button" name="but" class="btn btn-primary" id="nonpaiement" value="X" onClick="nonpayer(\''.$idCmd.'\')"/>
                                             <br>';
                                        echo '</div>';
                                        echo '<div  style="display:table-cell;width:20%">';
                ...
                if($date = date('N') == 6){ // == 6   LIVRAISON
                    ...
                    $query4="select COUNT(*) as existe from commandes where (dateLiv = curdate()) and adresse = 'Taleb Abderahmane 02' and (collecte = 1 and livre = 0)";
                    $result4=mysqli_query($link,$query4);
                    $obj4= mysqli_fetch_object($result4);
                    $existe = $obj4->existe;
                    if($existe != 0)
                    {
                        ...
                        $query5="select * FROM commandes where (dateLiv = curdate()) and adresse = 'Taleb Abderahmane 02' and (collecte = 1 and livre = 0)";
