        ...
        <div class="wrapper">
            ...
            <div id="content">
                        ...
                        <div class="navbar-header">
                            ...
                            <h2 style="padding-left:35%">COLLECTE ET LIVRAISON</h2>
                    ...
                    if($existe != 0)
                    {
                        ...
                        echo "<div style='display:inline'>"; 
                           echo "<p align='center' style='color:black;font-size:15px;font-weight: bold;float: left;width: 30%; padding-top:2%;margin-left:6%;padding-bottom:2%;background-color:white; margin-top:2% '>CITE UNIVERSITAIRE <br>".$row['adresse']."</p>";
                           echo "<p align='center' style='color:black;font-size:15px;font-weight: bold;float: left;width: 30%; padding-top:3%;padding-left:5%;padding-bottom:3.2%;background-color:white; margin-top:2% '> 20".$date = date('y-m-d')."   20:00 - 20:30 </p>";
                           echo "<div align='center' style='color:black;font-size:15px;font-weight: bold;float: left;width: 30%; padding-top:2.2%;padding-left:5%;padding-bottom:2.7%;background-color:white; margin-top:2%'> <button style=' ' class='btn btn-primary' id='btn' name='btn' onClick='affichergoogle(\"".$adr."\")'> <!--<img style='width:130%; padding-left:0' src='assets/img/route.jpg'> --> ROUTE </button> </div>";
                        echo "</div>";
                        echo "</div>";
