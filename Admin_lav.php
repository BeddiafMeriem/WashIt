    ...
    <div class="container-fluid page-body-wrapper" style="background-color:#F2F2F2">
      ...
      <!-- partial -->
              ...
              <div class="card" id="car" style="width:90%;margin-left:5%; margin-right:5%;margin-top:5%;margin-bottom:5%">
                <div class="card-body">
                  <h2 class="card-title"> Les responsables laveries </h2>
                  <div>
                  ...
                  <div class="table-responsive">
                    <table id="myTable" class="table table-hover">
                      ...
                      $i = 0;
                      $query="select * FROM users where type='lav' and usersupp=0";
                ...
                <div class="card" style="width:90%;margin-left:5%; margin-right:5%;margin-top:5%;margin-bottom:5%">
                    <div class="card-body">
                      <h4 class="card-title">Ajouter un responsable laverie</h4>
...
function supprimer(i) {
   ...
   var type = "lav";
   var conf = confirm("Le responsable laverie "+name+" sera supprimée de la liste, Voulez vous poursuivre");
                    if(conf == true)
                    {
                      $.ajax({
