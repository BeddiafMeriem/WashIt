        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <div align="center" style="background:#F2F2F2;padding-bottom:20px;margin-top:20px; margin-right:2px; margin-left:2px">
                 ...
                 <li class="active"><a href="transport-profile.php">Mon Profile</a></li>
                </ul>
            ...
            echo "<div class='row' style='margin-top:5%'>";
                echo "<div class='col-md-12 portfolio-group no-padding'>";
                    ...
                    echo "<div style='' class='col-md-4 portfolio-item margin-bottom-40 video'>";
                    echo "<a  onClick='modifierTel()' style='margin-left:25%'>";
            ...
            echo "<div class='row' style='margin-top:5%'>";
              echo "<div class='col-md-12 portfolio-group no-padding'>";
                ...
                echo "</div>";
                echo "<div style='' class='col-md-4 portfolio-item margin-bottom-40 video'>";
                    echo "<p align='center' style='margin-left:-10%;color:black;font-weight:bold;font-size: 20px'>$mail</p>";
                echo "</div>";
                echo "<div style='' class='col-md-4 portfolio-item margin-bottom-40 video'>";
                    echo "<a  onClick='modifierMail()' style='margin-left:25%'>";
                     echo "<img  style='' class='btn' src='assets/img/modifier.png'>";
                    echo "</a>";
                echo "</div>";
              echo "</div>";
            ...
            echo "<div class='row' style='margin-top:5%'>";
              echo "<div class='col-md-12 portfolio-group no-padding'>";
                ...
                echo "</div>";
                echo "<div style='' class='col-md-4 portfolio-item margin-bottom-40 video'>";
                    echo "<a  onClick='modifierAdr()' style='margin-left:25%'>";     
                      echo "<img   class='btn' src='assets/img/modifier.png'>";               
                    echo "</a>";
                echo "</div>";
