            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
              ...
              <a class="dropdown-item preview-item">
                ...
                <div class="preview-item-content flex-grow">
                  <h6 class="preview-subject ellipsis font-weight-medium text-dark">Mohamed
                    <span class="float-right font-weight-light small-text">1 Minutes </span>
                  </h6>
              ...
              <a class="dropdown-item preview-item">
                ...
                <div class="preview-item-content flex-grow">
                  <h6 class="preview-subject ellipsis font-weight-medium text-dark">Nabil
                    <span class="float-right font-weight-light small-text">15 Minutes </span>
                  </h6>
                  <p class="font-weight-light small-text">
                    Nouvelle connexion
                  </p>
              ...
              <a class="dropdown-item preview-item">
                ...
                <div class="preview-item-content flex-grow">
                  <h6 class="preview-subject ellipsis font-weight-medium text-dark"> Nacim
                    <span class="float-right font-weight-light small-text">18 Minutes</span>
                  </h6>
                  <p class="font-weight-light small-text">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              <a class="dropdown-item">
                <p class="mb-0 font-weight-normal float-left">Vous avez 4 nouvelles notifications
                </p>
                <span class="badge badge-pill badge-warning float-right">Voire tout</span>
              </a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item preview-item">
                <div class="preview-thumbnail">
                ...
                <div class="preview-item-content">
                  <h6 class="preview-subject font-weight-medium text-dark">Erreur d'application</h6>
                  <p class="font-weight-light small-text">
                    Maintenant
                  </p>
                </div>
              ...
              <a class="dropdown-item preview-item">
                ...
                <div class="preview-item-content">
                  <h6 class="preview-subject font-weight-medium text-dark">Paramètres</h6>
                  <p class="font-weight-light small-text">
                    Message privé
                  </p>
                </div>
              ...
              <a class="dropdown-item preview-item">
                ...
                <div class="preview-item-content">
                  <h6 class="preview-subject font-weight-medium text-dark">Nouvelle registration d'utilisateur</h6>
                  <p class="font-weight-light small-text">
                    2 jours 
                  </p>
                </div>
        ...
        <div class="content-wrapper">
                ...
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      <p class="mb-0 text-right">Les revenux totaux</p>
                  ...
                  <p class="text-muted mt-3 mb-0">
                    <i class="mdi mdi-alert-octagon mr-1" aria-hidden="true"></i> 65% croissance plus faible
                  </p>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
              <div class="card card-statistics">
                <div class="card-body">
                  ...
                  <p class="text-muted mt-3 mb-0">
                    <i class="mdi mdi-bookmark-outline mr-1" aria-hidden="true"></i> lavage des commandes
                  </p>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
              <div class="card card-statistics">
                <div class="card-body">
                  ...
                  <p class="text-muted mt-3 mb-0">
                    <i class="mdi mdi-calendar mr-1" aria-hidden="true"></i> Articles par semaine
                  </p>
                </div>
              </div>
            </div>
                ...
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      ...
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0">146</h3>
                      </div>
                    </div>
                  </div>
                  <p class="text-muted mt-3 mb-0">
                    <i class="mdi mdi-reload mr-1" aria-hidden="true"></i> Utilisateurs de l'application
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="row">
              ...
              <div class="card card-weather">
                <div class="card-body">
                  <div class="weather-date-location">
                    <h3>Mercredi</h3>
                    <p class="text-gray">
                      <span class="weather-date">10 Juillet 2019</span>
                      <span class="weather-location">Alger, ALgérie</span>
                    </p>
                  </div>
                  <div class="weather-data d-flex">
                    <div class="mr-auto">
                      <h4 class="display-3">31
            ...
            <div class="col-lg-5 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h2 class="card-title text-primary mb-5">Historique des activités</h2>
                  <div class="wrapper d-flex justify-content-between">
                    <div class="side-left">
                      <p class="mb-2">La meilleure activité</p>
                  ...
                  <div class="wrapper d-flex justify-content-between">
                    <div class="side-left">
                      <p class="mb-2">la pire activité</p>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row d-none d-sm-flex mb-4">
                    <div class="col-4">
                      <h5 class="text-primary"> Visiteurs</h5>
                      <p>54657</p>
                    </div>
                    <div class="col-4">
                      <h5 class="text-primary">Commandes</h5>
                      <p>45673</p>
                    </div>
                    <div class="col-4">
                      <h5 class="text-primary">Commandes annulées</h5>
                      <p>73</p>
                    </div>
                  </div>
          ...
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title mb-4">Messages</h5>
                  <div class="fluid-container">
                    <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                      ...
                      <div class="ticket-details col-md-9">
                        <div class="d-flex">
                          <p class="text-dark font-weight-semibold mr-2 mb-0 no-wrap">Mohamed :</p>
                          <p class="text-primary mr-1 mb-0">[#23047]</p>
                          <p class="mb-0 ellipsis">Nouvelle tentative d'inscription</p>
                        </div>
                        <p class="text-gray ellipsis mb-2">Une nouvelle inscription est sauvegardée
                        </p>
                        ...
                        <div class="btn-group dropdown">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="#">
                              <i class="fa fa-reply fa-fw"></i>Réponse</a>
                            <a class="dropdown-item" href="#">
                              <i class="fa fa-history fa-fw"></i>D'autres actions</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="#">
                              <i class="fa fa-check text-success fa-fw"></i>Régler le problème</a>
                            <a class="dropdown-item" href="#">
                              <i class="fa fa-times text-danger fa-fw"></i>Fermer le problème</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                      ...
                      <div class="ticket-details col-md-9">
                        <div class="d-flex">
                          <p class="text-dark font-weight-semibold mr-2 mb-0 no-wrap">Kenza :</p>
                          <p class="text-primary mr-1 mb-0">[#23135]</p>
                          <p class="mb-0 ellipsis">Une anomalie lors de la collecte</p>
                        </div>
                        <p class="text-gray ellipsis mb-2">une commande collectée sans etre payée
                        </p>
                        <div class="row text-gray d-md-flex d-none">
                          <div class="col-4 d-flex">
