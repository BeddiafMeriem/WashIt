        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <div align="center" style="background:#F2F2F2;padding-bottom:20px;margin-top:20px; margin-right:2px; margin-left:2px">
                 ...
                 ?>
                    ...
                    <li class="active">
                    <a style="margin-top:20%" href="lav3.php">Accueil</a>
                    </li>
            ...
            <div id="content">
                        ...
                        <div class="navbar-header">
                            ...
                            <h2 align="center" style="">LAVERIE L’ORCHIDEE </h2>
                        <?php 
                    ...
                    $query4="select COUNT(*) as existe from commandes,cites where (collecte=1 and lave=0) and (adresse = 'Taleb Abderahmane 01' or adresse = 'Taleb Abderahmane 02' or adresse = 'Taleb Abderahmane 03' or adresse = 'Jeune Fille') order by(cites.ordre)";
                    ...
                    if($existe != 0)
                    {
                        ...
                        $query1="select * from commandes where (collecte=1 and lave=0) and (adresse = 'Taleb Abderahmane 01' or adresse = 'Taleb Abderahmane 02' or adresse = 'Taleb Abderahmane 03' or adresse = 'Jeune Fille') order by(adresse)";
                               ...
                               while($row2=$result2->fetch_assoc())
                               {
                                ...
                                echo "<div class='row' style='width:100%; margin-top:1%'>";
                                    echo "<div style='display:inline'>"; 
                                        echo "<p align='center' style='color:black;font-size:15px;font-weight: bold;float: left;width: 30%; padding-top:15px;margin-left:6%;padding-bottom:18px;background-color:white; margin-top:2% '>COMMANDE N° ".$row['idCommande']."</p>";
                                ...
                                echo "</div>";
                                echo "<div id='laver$id' style='margin-top:20px;display:none'>"; 
                                    echo "<button style='background-color:#78B3DC;margin-top:5px;margin-left:48%;border:0;margin-top:15px;text-align:center;width:100px' class='btn btn-primary' id='btn' name='btn' onClick='laver(\"".$id."\")'> LAVER </button>";
                                echo "</div>";
                        }
                    }
