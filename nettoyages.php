    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <div align="center" style="background:#F2F2F2;padding-bottom:20px;margin-top:20px; margin-right:2px; margin-left:2px">
                 ...
                 {  
                    ...
                    <li class="active"><a href="nettoyages.php">Mes Nettoyages</a></li>
            ...
            <div id="content">
                        ...
                        <h2 align="center" style="text-align:center">MES NETTOYAGES </h2> 
                       
                        <?php
                        
                        echo '<h2 align="center" style="padding-bottom:5%;margin-left:3%">'.$date = date('Y-m-d').'</h2>';
                        ?>  
                    ...
                    $query4="select COUNT(*) as existe from commandes where (adresse = '".$adr1."' or adresse = '".$adr2."' or adresse = '".$adr3."' or adresse = '".$adr4."') and (lave = 1)";
                    ...
                    if($existe != 0)
                    {
                        ...
                        echo "<div>";
                        echo "<h3 align='center' style='font-weight: bold; margin-top: 0px; color:#ADB5BD ; margin-left:5% ; margin-bottom:5%'>COMMANDES LAVEES</h3>";
                        echo "</div>";
                        
                        echo "<div style='margin-left:10%'>";
                        echo "<div id='c1' style='font-weight: bold;margin-left:%;float: left;width: 30%;justify-content: center;align-items: center;padding-left:%;margin-bottom:10px;text-align:center '> N° Commandes </div>";
                        echo "<div id='c3' style='font-weight: bold;float: left;width: 30%;justify-content: center;align-items: center; padding-left:%;text-align:center'> Nombre d'articles </div>";
                        echo "<div id='c3' style='font-weight: bold;float: left;width: 30%;justify-content: center;align-items: center; padding-left:%;text-align:center'> Adresse </div>";
                        echo "</div>";

                        $query1="select * FROM commandes where (adresse = '".$adr1."' or adresse = '".$adr2."' or adresse = '".$adr3."' or adresse = '".$adr4."') and (lave = 1)";
                        ...
                        while($row1=$result1->fetch_assoc())
                        {
                                ...
                                echo '<div  style="width:80%;margin-left:10%;display:table; border:0px">';
